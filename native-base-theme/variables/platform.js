...
export default {
    ...
    // CheckBox
    CheckboxRadius: platform === "ios" ? 5 : 0,
    ...
    checkboxSize: 20,
    checkboxTickColor: this.grayBase,
    ...
    // Color
    brandPrimary: platform === "ios" ? "#00bc84" : "#3F51B5",
    brandInfo: "#72ddf7",
    brandSuccess: "#00bc84",
    brandDanger: "#a40606",
    brandWarning: "#fe5D26",
...
// Font
    ...
    tabBarActiveTextColor: platform === "ios" ? "#fffbfa" : "#fff",
    tabActiveBgColor: platform === "ios" ? "#00bc84" : "#3F51B5",
    ...
    // Header
    toolbarBtnColor: platform === "ios" ? "#fffbfa" : "#fff",
    toolbarDefaultBg: platform === "ios" ? "#25283d" : "#3F51B5",
    ...
    // New Variable
    titleFontColor: platform === "ios" ? "#fffbfa" : "#FFF",
